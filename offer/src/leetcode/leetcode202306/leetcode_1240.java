...
//        System.out.println(new leetcode_1240().tilingRectangle(11,13));
//    }
//    public int tilingRectangle(int n, int m) {
//        ans=n*m;
//        dfs(Math.min(n, m), n * m, 0);
//        return ans;
//    }
//
//    int ans;
//
//    public void dfs(int maxLen, int residualArea, int count) {
//        if (residualArea == 0 || residualArea == 1) {
//            ans = Math.min(ans, residualArea + count);
//            return;
//        }
//        for (int i = maxLen; i > 1; i--) {
//            if (residualArea >= i * i) {
//                dfs(maxLen, residualArea - i * i, count + 1);
//            }
//        }
//    }
